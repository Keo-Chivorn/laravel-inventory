                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="d-flex justify-content-between">
                                <a type="button" data-toggle="modal" data-target="#form-edit" data-whatever="@mdo" class="btn btn-success btn-circle">
                                    <i class="fas fa-pen"></i>
                                </a>

                                @include('product.edit')

                                <a href="#" class="btn btn-danger btn-circle btn-delete">
